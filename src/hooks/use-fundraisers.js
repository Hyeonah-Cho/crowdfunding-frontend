...
// This is the same as using `export default useFundraisers` at the end of the code, exporting the function itself in the file - this is differnet from `export default useFundraisers()`, which only exports the return value of the fuction.
